...
class UserController extends Controller
{
    ...
    {
        $page_title = __('locale.titles.users');
        $breadcrumbs = [
            ['name' => $page_title],
        ];

        $stats = [
            'total_transactions' => User::count(),
            'credit_transactions' => User::active()->count(),
            'debit_transactions' => User::inactive()->count(),
        ];

        return view('admin.users.index', compact('page_title', 'stats', 'breadcrumbs'));
    }
