            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-bs-toggle="dropdown" href="#">
                    ...
                    <span class="navbar-badge badge text-bg-warning">{{
                        \App\Models\Notification::forUser(Auth::user()->id)->unread()->count() }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <span class="dropdown-item dropdown-header">{{
                        \App\Models\Notification::forUser(Auth::user()->id)->unread()->count() }} Notifications</span>
                    <div class="dropdown-divider"></div>
                    @foreach (\App\Models\Notification::forUser(Auth::user()->id)->unread()->get() as $item)
                    <a href="#" class="dropdown-item">
                        <i class="bi bi-save-fill me-2"></i> {{ $item->message }}
                        <span class="float-end text-secondary fs-7">{{ Carbon::parse($item->created_at)->diffForHumans()
                            }}</span>
                    </a>
                    <div class="dropdown-divider"></div>
                    @endforeach
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        ...
                        <a href="#" class="btn btn-light btn-sm mb-0 mt-4"><i class="bi bi-pencil-square"></i>
                            Profile</a>
                    </li>
                    <!--end::User Image-->
                    <!--begin::Menu Body-->
